...
export default function About() {
  return (
    <>
      <SEOHead
        title="About HexaSend | The Future of File Sharing"
        description="Learn how HexaSend revolutionizes peer-to-peer file transfer. Discover our mission to make sharing files instantly secure, absolutely free, and ridiculously simple with just a 6-digit code."
        keywords="about hexasend, HexaSend mission, file transfer technology, secure file sharing"
      />
