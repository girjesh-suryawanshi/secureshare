...
export default function Disclaimer() {
  return (
    <>
      <SEOHead
        title="Disclaimer | HexaSend Usage Limitations"
        description="Important legal disclaimer regarding the use of HexaSend for file transfers. Understand our liability limits and service warranties for secure document sharing."
      />
