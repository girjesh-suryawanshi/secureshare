...
export default function Terms() {
  return (
    <>
      <SEOHead
        title="Terms of Service | HexaSend File Sharing"
        description="Review the terms and conditions for using HexaSend. Learn about our user agreement, service availability, and acceptable use policies for secure file sharing."
      />
